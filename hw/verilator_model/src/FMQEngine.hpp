...
namespace PsPIN
{
    ...
    public:
        ...
        FMQEngine(fmq_control_port_concrete_t& ni_port,
        ...
        {
            // ni_not_ready is the case where we are already trying to send
            // a feedback but the NI is not ready (stalling on feedbacks)
            if (ni_not_ready)
                return;
